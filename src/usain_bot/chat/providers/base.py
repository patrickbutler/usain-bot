...
never on a concrete SDK. Swapping Anthropic for another vendor means
adding one new file under chat/providers/ and a factory entry — nothing
in the orchestration loop, tool definitions, or web/chat layer changes.
"""
